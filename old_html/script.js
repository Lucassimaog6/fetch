...
function loadCountries() {
	...
	constructList(countriesUl, countriesList, favoriteCountry);
...
function loadFavorites() {
	...
	constructList(favoritesUl, favoritesList, UnfavoriteCountry);
}

function constructList(ul, data, func) {
	ul.innerHTML = '';
...
function UnfavoriteCountry(index) {
	countriesList.push(favoritesList[index]);
